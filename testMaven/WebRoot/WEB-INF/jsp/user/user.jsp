...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <ul class="search" style="padding-left: 10px;">
            <li>
                <a class="button border-main icon-plus-square-o" href="${ctx}/user/add">新增用户</a>
            </li>
        </ul>
    </div>
        ...
        <tr>
            ...
            <td>
                <div class="button-group">
                    <a class="button border-main" href="${ctx}/user/update2?id=${data.id}"><span class="icon-edit">修改</span> </a>
